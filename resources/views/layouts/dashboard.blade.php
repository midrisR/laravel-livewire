...
<body class="bg-slate-100">
    <div class="flex">
        <aside
            class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0 min-h-screen transition-all ease-in-out duration-300 ease-in-out">
            <div class="my-3 px-4">
                <span class="relative py-3 text-blue-500 text-2xl font-black">
                    GBS
                </span>
            </div>
            <ul class="px-4">
    ...
    <script>
        ...
        let span = document.querySelectorAll('ul span')
        collapse.onclick = () => {
