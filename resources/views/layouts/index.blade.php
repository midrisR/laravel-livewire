...
<head>
    ...
    <meta name="description"
        content="@yield('description','Jual pipa,fitting,flange dengan berbgai jenis dan tipe')">
    <meta name="keywords" content="@yield('keywords')">
    <meta name="author" content="Cv. Gravindo Berkati Sukses">
    <meta property=og:site_name
        content="@yield('site_name','CV. GRAVINDO BERKATI SUKSES')" />
    <meta property="og:url"
        content="@yield('url','https://www.gravindoberkatisukses.co.id/')" />
    <meta property="og:type" content="website" />
    <meta property="og:title"
        content="@yield('og:title','CV. GRAVINDO BERKATI SUKSES')" />
