<div class="w-full bg-gray-800 px-20 py-5">
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 px-0 lg:px-12">
            ...
            <div class="flex">
                <div class="bg-white rounded-lg w-8 h-8 overflow-hidden p-1 mr-3">
                    <img src="{{ asset('storage/photos/icons/facebook.svg') }}" alt="" width="100">
                </div>
                <div class="bg-white rounded-lg w-8 h-8 overflow-hidden p-1 mr-3">
                    <img src="{{ asset('storage/photos/icons/instagram.svg') }}" alt="" width="100">
                </div>
                <div class="bg-white rounded-lg w-8 h-8 overflow-hidden p-1 mr-3">
                    <img src="{{ asset('storage/photos/icons/shopee.svg') }}" alt="" width="100">
                </div>
                <div class="bg-white rounded-lg w-8 h-8 overflow-hidden p-1 mr-3">
                    <img src="{{ asset('storage/photos/icons/tokopedia.svg') }}" alt="" width="100">
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- wa --}}
    <div class="fixed bottom-5 right-5 z-20 p-3 bg-green-500 rounded-full cursor-pointer" id="whatsaap">
...
@push('script')
<script>
    const wa = document.getElementById("whatsaap");
